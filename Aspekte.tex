...
Im Rahmen dieses Projektes beinhaltet der Aspekt Wissenschaft verschiedene Teilaspekte die dann jeweils anhand von verschiedenen Ländern verglichen werden. Einige dieser Teilaspekte sind schwierig zu recherchieren, zu bestimmten Aspekten sind auch gar keine Aussagen möglich, dort besteht dann Forschungsbedarf. 

Der Aspekt Wissenschaft beinhaltet in dieser Arbeit nicht nur die universitäre Forschung. Auch die Forschung in verschiedenen Unternehmen gehört zur zum Aspekt Wissenschaft. Weiterhin soll unter diesem Aspekt auch der Bildungsstand des Landes dargestellt werden sowie die Ausbildungssituation.

Teilweise ist es für die einzelnen Teilaspekte schwierig spezifische Daten zum IT-Consulting zu finden, da z.B. die Studienfinanzierung oft in Ingenieurwissenschaften und Wirtschaftswissenschaften unterteilt. IT-Consulting als interdisziplinär ausgerichtetes Fach ist deswegen oft schwer in den einzelnen Statistiken zuzuordnen. 

Im Folgenden werden die verschiedene Teilaspekte durch die sich wissenschaftliche Situation charakterisieren lässt dargestellt und erläutert.
...
(Ausführliche Disskussion des Verhältnisses von Praxis zu Theorie auf S.23 ff)
