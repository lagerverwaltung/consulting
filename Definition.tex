...
In der Literatur als auch in der Umgangsprache scheint es war einen generellen Konsens zu geben was den Begriff Unternehmensberatung angeht. 
...
\item ploy (Strategie als Spielzeug, Auswahl der taktische Maßnahmen) 
\cite{5Ps}
\end{itemize}
...
\subsection{IT-Beratung}
	\subsubsection{Grund für den Zuwachs von IT-Beratung}
		...
		\subsubsection{Zusammenfassung}
			...
			Regulierung/Deregulierung,  Privatisierung oder Kulturanalyse und -anpassung, Prozessberatung und  interkulturelle Beratung''.\cite{ReinekeBock200709}
